...
def quadratic_majorana_from_dirac(p, q):
    """
    ...
    for term in product(_dirac_to_majorana('a^', p), _dirac_to_majorana('a', q)):
        ...
        majorana_data[tuple(majorana_ints)] = majorana_data[tuple(majorana_ints)] + phase

    return majorana_data


def quartic_majorana_from_dirac(p, q, r, s):
    """
...
if __name__ == "__main__":
    print(quartic_majorana_from_dirac(0, 1, 1, 0), '\n\n')

    # print(quadratic_majorana_from_dirac(0, 2))